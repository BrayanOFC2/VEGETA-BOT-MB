...
var handler = async function (m, conn, db) {
    ...
    let fotoperfil = await conn.profilePictureUrl(who, 'image').catch(() => 'https://files.catbox.moe/2v85gv.mp4')
    ...
    let asistencia = 'Wa.me/526641784469'
    ...
    let canalNombreM = ["𝚅𝙴𝙶𝙴𝚃𝙰-𝙱𝙾𝚃-𝙼𝙱*", "𝚅𝙴𝙶𝙴𝚃𝙰-𝙱𝙾𝚃-𝙼𝙱"]
    ...
    let rcanal = {
        contextInfo: {
            ...
            externalAdReply: {
                ...
                body: '☁️By BrayanOFC🐉',
                previewType: "PHOTO",
                thumbnailUrl: "https://files.catbox.moe/2v85gv.mp4",
