...
`.trim();
  ...
  if (!who) return conn.sendMessage(m.chat, {text: '☁️ Debes mencionar a alguien para poder hacerle la transferencia.', mentions: [m.sender]}, {quoted: m});
...
handler.before = async (m) => {
  ...
  if (/^No|no$/i.test(m.text)) {
    ...
    return conn.sendMessage(m.chat, {text: '☁️ Cancelando, la transferencia no se realizara.', mentions: [m.sender]}, {quoted: m});
  }
