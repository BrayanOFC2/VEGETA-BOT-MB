...
```bash
git clone https://github.com/brayan127p/VEGETA-BOT-MB2.0 && cd VEGETA-BOT-MB
```
...
------------------
#### **`☁️ ACTIVAR EN RENDER`**
[![Deploy to Render](https://binbashbanana.github.io/deploy-buttons/buttons/remade/render.svg)](https://dashboard.render.com/blueprint/new?repo=https%3A%2F%2Fgithub.com%2BrayanOFC%2FVEGETA-BOT-MB)
