...
≡ ✢ ${chalk.vegeta(chalk.bgRed(new Date().toLocaleTimeString()))}
≡ ‣ ${chalk.vegeta(chalk.bgGreen(m.messageStubType ? WAMessageStubType[m.messageStubType] : ''))}
...
≡ ⎙ ${chalk.vegeta(chalk.bgYellow(m.mtype ? m.mtype.replace(/message$/i, '').replace(/^./, v => v.toUpperCase()) : ''))}
${chalk.hex('#fe1e00').bold('┈──────────────── ꒰ 🐉 VEGETA-BOT-MB: ꒱')}
`
