...
conn.isInit = false;
conn.well = false;
//conn.logger.info(ʕ•ᴥ•ʔ  H E C H O  Saiyajin☁️🔥\n)
...
console.log(chalk.bold.cyanBright(\n⚠︎ SIN CONEXIÓN, BORRE LA CARPETA ${global.sessions} Y ESCANEA EL CÓDIGO QR SAIYAJIN☁️⚠︎))
...
console.log(chalk.bold.yellowBright(\n╭┄┄┄┄┄┄┄┄┄┄┄┄┄┄ • • • ┄┄┄┄┄┄┄┄┄┄┄┄┄┄ ✗\n┆ ⚠︎ CONEXIÓN REEMPLAZADA, SE HA ABIERTO OTRA NUEVA SESION, POR FAVOR, CIERRA LA SESIÓN ACTUAL PRIMERO SAIYAJIN☁️👑.\n╰┄┄┄┄┄┄┄┄┄┄┄┄┄┄ • • • ┄┄┄┄┄┄┄┄┄┄┄┄┄┄ ✗))
} else if (reason === DisconnectReason.loggedOut) {
console.log(chalk.bold.redBright(\n⚠︎ SIN CONEXIÓN SAIYAJIN, BORRE LA CARPETA ${global.sessions} Y ESCANEA EL CÓDIGO QR☁️👑 ⚠︎))
await global.reloadHandler(true).catch(console.error)
} else if (reason === DisconnectReason.restartRequired) {
console.log(chalk.bold.cyanBright(\n╭┄┄┄┄┄┄┄┄┄┄┄┄┄┄ • • • ┄┄┄┄┄┄┄┄┄┄┄┄┄┄ ✓\n┆ ✧ CONECTANDO AL SERVIDOR Y VEGETA☁️👑...\n╰┄┄┄┄┄┄┄┄┄┄┄┄┄┄ • • • ┄┄┄┄┄┄┄┄┄┄┄┄┄┄ ✓))
await global.reloadHandler(true).catch(console.error)
} else if (reason === DisconnectReason.timedOut) {
console.log(chalk.bold.yellowBright(\n╭┄┄┄┄┄┄┄┄┄┄┄┄┄┄ • • • ┄┄┄┄┄┄┄┄┄┄┄┄┄┄ ▸\n┆ ⧖ TIEMPO DE CONEXIÓN AGOTADO SAIYAJIN, RECONECTANDO....\n╰┄┄┄┄┄┄┄┄┄┄┄┄┄┄ • • • ┄┄┄┄┄┄┄┄┄┄┄┄┄┄ ▸))
await global.reloadHandler(true).catch(console.error) //process.send('reset')
} else {
console.log(chalk.bold.redBright(\n⚠︎！ RAZON DE DESCONEXIÓN DESCONOCIDA SAIYAJIN👑☁️: ${reason || 'No encontrado'} >> ${connection || 'No encontrado'}))
}}
}
...
console.log(chalk.bold.green(\n╭» ❍ ${jadi} ❍\n│→ NADA POR ELIMINAR SAIYAJIN☁️👑\n╰― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ⌫ ♻︎))
} else {
console.log(chalk.bold.cyanBright(\n╭» ❍ ${jadi} ❍\n│→ ARCHIVOS NO ESENCIALES ELIMINADOS SAIYAJIN☁️👑\n╰― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ⌫ ♻︎︎))
}} catch (err) {
console.log(chalk.bold.red(\n╭» ❍ ${jadi} ❍\n│→ OCURRIÓ UN ERROR SAIYAJIN☁️👑\n╰― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ⌫ ♻\n + err))
}}
...
if (err) {
console.log(chalk.bold.red(\n╭» ❍ ARCHIVO ❍\n│→ ${file} NO SE LOGRÓ BORRAR SAIYAJIN☁️👑\n╰― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ⌫ ✘\n + err))
} else {
console.log(chalk.bold.green(\n╭» ❍ ARCHIVO ❍\n│→ ${file} BORRADO CON ÉXITO SAIYAJIN👑☁️\n╰― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ― ⌫ ♻))
} }) }
}) }) }) }
...
_quickTest().then(() => conn.logger.info(chalk.bold(✦  H E C H O SAIYAJIN☁️👑\n.trim()))).catch(console.error)
...
Me editas el código porfavor y me lo envías completo y arreglado del error y no quites nd de console.log
